...
/**
 * 自定义的跑马灯效果的TextView这边可以设置属性
 */

public class HorizontalScrollTextView extends SurfaceView implements SurfaceHolder.Callback {

    public Context  mContext;

    private float mTextSize = 50; //字体大小
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = a.getDimension(R.styleable.MarqueeView_textSize, 35);
        mBackgroundColor=a.getColor(R.styleable.MarqueeView_marqueebackground,Color.parseColor("#fff4d8"));
    ...
    class MarqueeViewThread extends Thread{
        ...
        public boolean isRun = true;//是否在运行
