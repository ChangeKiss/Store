...
//    private int defualtBarWidth = 44; //柱状图个默认44宽
    ...
    public MtulLayerBarGraphView(Context context) {
        this(context,null);
    }
...
//        scaleHeight = height / 1080;
    ...
    private void init() {
        ...
        listOne.add(new BarGraphInfo(Color.parseColor("#f393a5"),"主布A",200));
        listOne.add(new BarGraphInfo(Color.parseColor("#f9c9d2"),"主布A",100));
        List<BarGraphInfo> listTwo = new ArrayList<>();
        listTwo.add(new BarGraphInfo(Color.parseColor("#f393a5"),"主布D",400));
        listTwo.add(new BarGraphInfo(Color.parseColor("#f9c9d2"),"主布C",200));
        List<BarGraphInfo> listThree = new ArrayList<>();
        listThree.add(new BarGraphInfo(Color.parseColor("#f393a5"),"主布E",300));
        listThree.add(new BarGraphInfo(Color.parseColor("#f9c9d2"),"主布F",100));
        List<BarGraphInfo> listFour = new ArrayList<>();
        listFour.add(new BarGraphInfo(Color.parseColor("#f393a5"),"主布G",200));
        listFour.add(new BarGraphInfo(Color.parseColor("#f9c9d2"),"主布H",100));
