...
public class BubbleIViewmpl implements BubbleTextViewStyle{

    private View mParentView;
    private BubbleCallback mHolderCallback;
    private BubbleViewDrawable mBubbleDrawable = new BubbleViewDrawable();
    ...
    void init(View view, Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mArrowHeight = ta.getDimension(R.styleable.BubbleStyle_bb_arrowHeight, ActivityUtils.dp2px(6));
            mArrowWidth = ta.getDimension(R.styleable.BubbleStyle_bb_arrowWidth, ActivityUtils.dp2px(10));
            ...
            float radius = ta.getDimension(R.styleable.BubbleStyle_bb_cornerRadius, ActivityUtils.dp2px(4));
