package com.Store.www.base.TableView;
...
public class TableView extends View{
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            rowHeight = typedArray.getDimensionPixelSize(R.styleable.TableView_rowHeight, ActivityUtils.dip2px(getContext(), 36));
            ...
            textSize = typedArray.getDimensionPixelSize(R.styleable.TableView_textSize, ActivityUtils.dip2px(getContext(), 10));
            ...
            headerTextSize = typedArray.getDimensionPixelSize(R.styleable.TableView_headerTextSize, ActivityUtils.dip2px(getContext(), 10));
            headerTextColor = typedArray.getColor(R.styleable.TableView_headerTextColor, Color.parseColor("#999999"));
            typedArray.recycle();
        } else {
            unitColumnWidth = 0;
            rowHeight = ActivityUtils.dip2px(getContext(), 36);
            dividerWidth = 1;
            dividerColor = Color.parseColor("#999999");
            textSize = ActivityUtils.dip2px(getContext(), 10);
            textColor = Color.parseColor("#999999");
            headerColor = Color.parseColor("#00ffffff");
            headerTextSize = ActivityUtils.dip2px(getContext(), 10);
            headerTextColor = Color.parseColor("#999999");
        }
     ...
     * @param headers
     */
    public TableView setHeader(List<String[]>  headers) {
        tableContents.addAll(headers);
        return this;
    }
