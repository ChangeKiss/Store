package com.Store.www.base.BubbleView;
...
/**
 * Created by www on 2018/11/5.
 */

public class BubbleViewDrawable extends Drawable{
    private BubbleTextViewStyle.ArrowDirection mArrowDirection = BubbleTextViewStyle.ArrowDirection.None;
    private BubbleTextViewStyle.ArrowPosPolicy mArrowPosPolicy = BubbleTextViewStyle.ArrowPosPolicy.TargetCenter;
    ...
    private static void updateFillArrowPeak(BubbleTextViewStyle.ArrowDirection direction, Shape borderShape, Shape outFillShape) {
        switch (direction) {
            case Left:
    ...
    private void updateBorderArrowPeak(BubbleTextViewStyle.ArrowDirection direction, BubbleTextViewStyle.ArrowPosPolicy policy, PointF arrowTo, Shape outShape) {
        switch (direction) {
            case Left:
                outShape.ArrowPeakX = outShape.Rect.left - outShape.ArrowHeight;
                outShape.ArrowPeakY = ActivityUtils.bound(outShape.Rect.top + outShape.TopLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                ...
                break;
            case Up:
                outShape.ArrowPeakX = ActivityUtils.bound(outShape.Rect.left + outShape.TopLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
            ...
            case Right:
                ...
                outShape.ArrowPeakY = ActivityUtils.bound(outShape.Rect.top + outShape.TopRightRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                ...
                break;
            case Down:
                outShape.ArrowPeakX = ActivityUtils.bound(outShape.Rect.left + outShape.BottomLeftRadius + outShape.ArrowWidth / 2 + outShape.BorderWidth / 2,
                        getUpDownArrowPeakX(policy, arrowTo, outShape),
    ...
    void setArrowDirection(BubbleTextViewStyle.ArrowDirection arrowDirection) {
        mArrowDirection = arrowDirection;
    }

    void setArrowPosPolicy(BubbleTextViewStyle.ArrowPosPolicy arrowPosPolicy) {
    ...
    private static float getLeftRightArrowPeakY(BubbleTextViewStyle.ArrowPosPolicy policy, PointF arrowTo, Shape shape) {
        float y;
        switch (policy) {
            case TargetCenter:
    ...
    private static float getUpDownArrowPeakX(BubbleTextViewStyle.ArrowPosPolicy policy, PointF arrowTo, Shape shape) {
        float x;
        switch (policy) {
            case TargetCenter:
