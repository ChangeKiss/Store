...
public class BubbleTextView extends TextView implements BubbleTextViewStyle,BubbleCallback{

    private BubbleIViewmpl mBubbleImpl = new BubbleIViewmpl();
    ...
    @Override
    public void setArrowDirection(BubbleTextViewStyle.ArrowDirection arrowDirection) {
        mBubbleImpl.setArrowDirection(arrowDirection);
    }

    @Override
    public BubbleTextViewStyle.ArrowDirection getArrowDirection() {
