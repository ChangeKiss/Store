...
import com.Store.www.ui.adapter.KeyBoardAdapter;
...
public class PasswordView extends RelativeLayout{
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        View view = View.inflate(context, R.layout.popwindow_withdraw_password, null);
        ...
        mTvFindPassword = (TextView) view.findViewById(R.id.tv_forgetPwd);
    ...
    public TextView getTvFindPassword(){
        return mTvFindPassword;
    }
}
