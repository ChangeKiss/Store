...
//        Glide.with(mContext).load(dataBean.getPictueUrl()).error(R.mipmap.jzz_img).into(holder.mIvNewsMoreImage);
        Glide.with(mContext)
                .load(dataBean.getPictueUrl())
                .asBitmap()
                .placeholder(R.mipmap.jzz_img)
                .diskCacheStrategy(DiskCacheStrategy.ALL) //设置缓存
                .into(new BitmapImageViewTarget((ImageView) holder.mIvNewsMoreImage) {
                    @Override
                    protected void setResource(Bitmap resource) {
                        ...
                        holder.mIvNewsMoreImage.setImageDrawable(circularBitmapDrawable);
                    }
                });
