...
public class RetrofitClient {
   ...
   /* //韩迪测试服务器地址
    ...
    public static Api create() {
        ...
        if (TextUtils.isEmpty(UserPrefsFirst.getInstance().getNetWork()))
            UserPrefsFirst.getInstance().setNetWork(ActivityUtils.getNetWorkStatus(MyApplication.getmContext()));
        if (TextUtils.isEmpty(UserPrefsFirst.getInstance().getCodeName()))
            UserPrefsFirst.getInstance().setCodeNma(ActivityUtils.getVersionName(MyApplication.getmContext()));
        if (TextUtils.isEmpty(UserPrefs.getInstance().getLoginToken()))
