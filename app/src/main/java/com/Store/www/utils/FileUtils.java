...
public class FileUtils {
    ...
    public static final String mFileName = "/Kivie";
    ...
    public static String getSavePath(String fileName) {
        return createDir(getSDPath() + "/" + mFileName + "/" + fileName);
    }
    ...
    //删除安装包
    public static File getPathFile(String path ,String apkName){
    ...
    public static void rmoveFile(String path,String apkName){
        File file = getPathFile(path,apkName);
        file.delete();
        LogUtils.d("删除APK成功");
    }
