...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        mButton.setClickable(false); //设置按钮不可点击
        mButton.setText(millisUntilFinished/1000+"秒后重新发送"); //设置提醒时间
        mButton.setBackgroundResource(R.drawable.selector_smallbutton_gold); //设置按钮颜色 此时按钮不可点击
    ...
    public void onFinish() {
        ...
        mButton.setBackgroundResource(R.drawable.selector_smallbutton_gold);
    }
}
