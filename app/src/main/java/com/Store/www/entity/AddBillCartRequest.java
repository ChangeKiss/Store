...
public class AddBillCartRequest {
    ...
    public AddBillCartRequest(int repositoryId, String userId, int id, int productId, int count, List<SKUdataBean> SKUdata) {
